...
| --- | --- | --- | --- |
| Paper 26.1.2 | pinned ProtocolLib development build | 25 | Verified (1.0.2) |
| Paper 1.21.11 | pinned ProtocolLib development build | 25 | Verified (1.0.2) |
| Paper 1.21.8 | 5.4.0 | 21+ | Verified (1.0.2) |
| Other Paper 1.21.x | matching build for that version | 21+ | Expected, not verified |
| Paper 26.2 | pinned ProtocolLib development build | 25 | Verified (1.0.2) |
